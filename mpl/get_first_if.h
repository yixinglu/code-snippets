...
template <template <typename T> class Predicate, typename Default, typename... Rest>
struct get_first_if_impl;

template <template <typename T> class Predicate, typename Default, typename T, typename... Rest>
struct get_first_if_impl<Predicate, Default, T, Rest...> {
  using type = typename std::conditional<
                   Predicate<T>::value,
                   T,
                   typename get_first_if_impl<Predicate, Default, Rest...>::type
               >::type;
};
